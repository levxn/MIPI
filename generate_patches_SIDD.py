...
parser.add_argument('--tar_dir', default='target/train',type=str, help='Directory for image patches')
...
files = [os.path.join(src , i) for i in files_]
...
def save_files(i):
    ...
    for j in range(NUM_PATCHES):
        ...
        #print(os.path.join(noisy_patchDir, '{}_{}.png'.format(i+1,j+1)))
